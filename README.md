...
Mise à jour sans reformatage 
	— relance l'installeur sur une clé déjà préparée pour ne copier que ce qui a changé (nouvel ISO, nouvelle version de l'archive…).
...
Un projet Ofbridge Lab — [Blog](https://ofbridgelab.blogspot.com/) · suite TechFixer
